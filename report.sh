...
saveBackup="false"		# Change to "true" to save FreeNAS config backup (to below dir) after mail is sent; "false" to delete them
...
(
	...
	echo "  <th style=\"text-align:center; width:130px; height:60px; border:1px solid black; border-collapse:collapse; font-family:courier;\">Power-On<br>Time</th>"
